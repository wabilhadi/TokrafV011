      ...
      <section className="relative min-h-[60vh] flex items-end pb-24 overflow-hidden rounded-b-[3rem] shadow-2xl mb-24">
        ...
        <div className="relative z-10 max-w-[1400px] w-full mx-auto px-6 md:px-12 mt-32">
          <motion.h1 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }}
            className="text-4xl md:text-7xl font-extrabold font-heading text-white tracking-tighter leading-tight mb-8">
            {t('portofolio.gallery')}
          </motion.h1>
          <p className="text-2xl font-light text-white/80 max-w-2xl">{t('portofolio.galleryDesc')}</p>
        </div>
      </section>
